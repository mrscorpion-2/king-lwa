# lwazi Bot Mini AI Providers

Lwwzi Bot Mini keeps the existing OpenAI integration and adds explicit Gemini, DeepSeek, and Pollinations image-generation commands. Provider credentials are read only from the deployment environment; never paste keys into source files or commit them to GitHub.
